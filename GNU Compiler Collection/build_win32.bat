...
g++ -Wall -o PF_IA-32.exe -static-libstdc++ -static-libgcc -mwindows -DUNICODE -D_UNICODE 1.cpp
...
g++ -Wall obj.o resource.rc.o -o PF_IA-32.exe -static-libstdc++ -static-libgcc -mwindows -DUNICODE -D_UNICODE
if not exist "PF_IA-32.exe" goto errors
goto success
