...
g++ "%SRC%" -Wall -O2 -std=gnu++17 -mwindows -DUNICODE -D_UNICODE -static -s -o PF_IA-32.exe
if not exist "PF_IA-32.exe" goto error
goto success
...
g++ obj.o res.o -Wall -mwindows -static -s -o PF_IA-32.exe
if not exist "PF_IA-32.exe" goto error
goto success
