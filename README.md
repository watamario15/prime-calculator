...
- **[Wine](https://www.winehq.org/)**
  ...
  - macOS can run the AMD64 version via Rosetta 2

Read [Brain Wiki](https://brain.fandom.com/ja/wiki/%E3%82%A2%E3%83%97%E3%83%AA%E3%81%AE%E8%B5%B7%E5%8B%95%E6%96%B9%E6%B3%95) to install on a Sharp Brain electronic dictionary.
...
- [Pocket GCC 1.50](https://ux.getuploader.com/brainup2ch/download/37) via [`src/pgcc.bat`](src/pgcc.bat)
  - Set up PocketGCC and a command shell on your Windows CE device (see [Brain Wiki](https://brain.fandom.com/ja/wiki/%E3%83%97%E3%83%AD%E3%82%B0%E3%83%A9%E3%83%9F%E3%83%B3%E3%82%B0)) and use [`src/pgcc.bat`](src/pgcc.bat)
  - Only `src` folder is needed to be transferred, and modify paths at the start of the batch file as needed
  - `commctrl.lib` is necessary, which is obtainable from the Standard SDK for eMbedded Visual C++ 4.0, etc (you will see many linker warnings but they are harmless)
