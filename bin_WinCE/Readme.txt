...
　ここにあるのが日本語版、「English」の中にあるのが英語版です。電子辞書の日本語化状況に合わせてお選びください。
...
　なお、新しい機種では実行できない場合もあります。対応機種等の情報はBrain Wiki等のWebサイトを参考にしてください。


・SHARP Brain以外のWindows CE端末について

　ARMv4Iの端末ならSHARP Brainと同じファイルを､別のCPUの端末なら「Other CPU」フォルダから適切なものを選び、端末所定の方法で実行してください｡
...
　しかし、このプログラムをテンプレートとして作成した全く別のプログラムの配布は認めます。強制はしませんが、ご一報くださると有り難いです。
