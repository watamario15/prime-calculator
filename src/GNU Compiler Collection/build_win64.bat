...
g++ -Wall -o PF_AMD64.exe -static-libstdc++ -static-libgcc -mwindows -DUNICODE 1.cpp
...
g++ -Wall obj.o resource.rc.o -o PF_AMD64.exe -static-libstdc++ -static-libgcc -mwindows -DUNICODE
if not exist "PF_AMD64.exe" goto errors
goto success
