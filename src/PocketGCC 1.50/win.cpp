...
#define NUMOFSTRINGTABLE 46 // Number of strings in the String Table
...
TCHAR tctemp[1024]/*Concatnate and receive*/, tcmes[NUMOFSTRINGTABLE][4096]/*Store statements*/, tcFile[MAX_PATH], tcEdit[65540];
CHAR cEdit[65540];
