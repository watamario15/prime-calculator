...
一時ファイル "C:\DOCUME~1\WATA\LOCALS~1\Temp\RSPD8.tmp" を作成し、次の内容を記録します
[
...
Creating command line "cl.exe @C:\DOCUME~1\WATA\LOCALS~1\Temp\RSPD8.tmp" 
一時ファイル "C:\DOCUME~1\WATA\LOCALS~1\Temp\RSPD9.tmp" を作成し、次の内容を記録します
[
...
コマンド ライン "link.exe @C:\DOCUME~1\WATA\LOCALS~1\Temp\RSPD9.tmp" の作成中
<h3>アウトプット ウィンドウ</h3>
リソースをコンパイル中...
コンパイル中...
1.cpp
