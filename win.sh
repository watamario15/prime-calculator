...
echo "*** [IA-32] Linking..."
i686-w64-mingw32-g++ ./*.o -static -s -lcomctl32 -lwinmm -mwindows -municode -o prime-win-32.exe
...
echo "*** [AMD64] Linking..."
x86_64-w64-mingw32-g++ ./*.o -static -s -lcomctl32 -lwinmm -mwindows -municode -o prime-win-64.exe
